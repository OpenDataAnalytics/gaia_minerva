...
Install Gaia-Minerva as a Girder plugin
~~~~~~~~~~~~~

-  Install Gaia-Minerva into the Girder plugins dir from source.

::

    cd GIRDER_DIR/plugins
    git clone https://github.com/opendataanalytics/gaia-minerva.git
...
- To enable analysis of WMS vector layers, customize the plugin configuration settings
    - located in gaia_minerva/server/conf/gaia_minerva.cfg
    - change 'servers' to a comma-delimited list of WMS server URL's that also support WFS.

- Activate Gaia analyses within Minerva.
